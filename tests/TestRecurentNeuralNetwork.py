from src.neura.core.RecurentNeuralNetwork import RNNAFDebug as RNN
import src.neura.utils.WordsProcessing as dp
import unittest

class TestMLP(unittest.TestCase):
    def testRNN(self):
        print(f"\n{'-'*40}Prueba Unitaria Para RecurentNeuralNetwork{'-'*40}\n")
